...
This module presents different methods to do spatial interpolation for the data.
...
For rainfall, we should aggregate by computing sum of rainfall for the month.
For temperature, we should aggregate by computing average temperature per month. 
