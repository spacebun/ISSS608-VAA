...
In this exercise, we'll apply **visual interactivity** and **visualizing uncertainty** methods to validate either of the [claims on future climate projection](https://www.nccs.gov.sg/singapores-climate-action/impact-of-climate-change-in-singapore/) in the infographic above that:
