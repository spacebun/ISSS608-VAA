...
-   Radio button selection for selecting variable to plot
-   Radio button selection for viewing across stations or viewing across years
-   

The plots below show the experimented views for this horizon plot feature.
...
https://cran.r-project.org/web/packages/dtwclust/vignettes/dtwclust.pdf We will divide cluster analysis into four different parts:

-   Format data into list of series
-   Choosing the clustering method: "partitional", "hierarchical", "tadpole" or "fuzzy"
-   Choosing distance computation: Ignored for type = "tadpole". Determining a measure to quantify the similarity between observations
